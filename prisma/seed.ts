...
// ---------------------------------------------------------------------------
// Construction stages — S-01 calibration (2026-06-09), PL cenniki etapowe
// Workbook: context/changes/cost-calibration/calibration-rates.md
// ---------------------------------------------------------------------------

const stages = [
  // --- UTILITY CONNECTIONS (S-05) ---
  {
    slug: "sewage_connection",
    name: "Przyłącze kanalizacji",
    description:
      "Przyłącze ścieków do sieci gminnej, szamba lub oczyszczalni — roboty zewnętrzne, bez instalacji wewnętrznej (→ plumbing)",
  ...
  },
  {
    ...
    name: "Przyłącze wody",
    description:
      "Przyłącze wody zewnętrzne — wodociąg gminny lub studnia głębinowa; bez instalacji wewnętrznej (→ plumbing)",
    category: "INSTALLATIONS",
    sortOrder: 2,
    completedByState: InvestmentState.FOUNDATIONS,
    predecessorSlugs: [],
  ...
  },
  {
    ...
    description:
      "Rury wodne i kanalizacyjne wewnątrz budynku, podejścia pod urządzenia — bez przyłącza do sieci zewnętrznej (→ S-05 utility-connections)",
    category: "INSTALLATIONS",
    sortOrder: 10,
    completedByState: InvestmentState.DEVELOPER,
    predecessorSlugs: ["windows_doors"],
...
const modifiers: ModifierInput[] = [
  ...
  // Roof type (S-02) — percent / flat on roof_structure + roof_covering
  // Workbook: context/changes/questionnaire-roof-type/roof-rates.md
  {
    stageSlug: "roof_structure",
  ...
  // Heating — kotłownia / źródło ciepła (flat by build standard, S-01)
  {
    stageSlug: "heating",
  ...
  // Utility connections (S-05) — flat per sewage_disposal (Std PLN)
  {
  ...
  // Utility connections — flat per water_supply (Std PLN)
  {
  ...
  // Distance add-ons — sewage_connection (gated to MUNICIPAL in compute-costs)
  {
    stageSlug: "sewage_connection",
  ...
  // Distance add-ons — water_connection (gated to MUNICIPAL in compute-costs)
  {
    stageSlug: "water_connection",
    triggerQuestionSlug: "utility_distance_band",
    triggerValue: "UP_TO_50M",
