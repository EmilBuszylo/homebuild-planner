...
module.exports = {
  forbidden: [
    {
      name: "not-to-test-fixtures",
      severity: "error",
      comment:
        "Production code must not import test fixtures; move shared data to a non-test module.",
      from: {
        path: "^src",
        pathNot: [
    ...
    {
      name: "plan-generation-stays-pure",
      severity: "error",
      comment:
        "plan-generation is a pure engine; persistence and auth belong in plan/ or API routes.",
      from: {
        path: "^src/lib/plan-generation",
        pathNot: "[.](?:spec|test)[.](?:js|mjs|cjs|jsx|ts|mts|cts|tsx)$",
      },
      to: {
        path: "^(src/lib/prisma|src/lib/supabase|@prisma/client)",
      },
    },
    {
      name: 'no-circular',
    ...
    },
    {
      ...
      from: {
        ...
        pathNot: [
          ...
          "(^|/)(?:page|layout|loading|error|not-found|global-error|route|template|default)[.](?:jsx?|tsx?)$",
          "(^|/)middleware[.]ts$",
          "(^|/)instrumentation[.]ts$",
        ],
      },
    ...
    },
    {
      ...
      to: {
        ...
        // Next.js subpath exports (next/server, next/navigation, …) are not resolved without webpack.
        pathNot: ["^next/"],
      },
    },
    {
    ...
    },
    {
      ...
      to: {
        ...
        pathNot: [
          "node_modules/@types/",
          // @sentry/nextjs is a devDependency but wired via next.config / instrumentation (optional in prod).
          "@sentry/nextjs",
        ],
      },
    },
...
// generated: dependency-cruiser@17.4.3 on 2026-06-12T10:42:31.164Z
